...
class Invoice extends BaseSale
{
     ...
     * @return float
     */
    public function getSumCargoGlobal()
    {
        return $this->sumCargoGlobal;
    }

    /**
     * @param float $sumCargoGlobal
     *
     * @return Invoice
     */
    public function setSumCargoGlobal($sumCargoGlobal)
    {
        $this->sumCargoGlobal = $sumCargoGlobal;
