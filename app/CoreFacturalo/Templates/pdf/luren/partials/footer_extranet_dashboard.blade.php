            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="card direccion">
                        <h4 class="card-header">PLANTA</h4>
                        <div class="card-body">
                            <h5 class="card-address" style="margin-bottom:0;">
                                <i class="fa fa-map-marker"></i> Antigua
                                Panamericana Sur Km 23.5 VES
                            </h5>
                            <p class="text-muted">
                                <i class="fa fa-map-marker"></i> Frente al
                                Complejo del Touring y Automóvil Club del
                                Perú
                            </p>
                            <p><i class="fa fa-phone"></i> (01) 295 7054</p>
                            <a href="https://goo.gl/maps/C9uErmHUfXuTDxbQ6" target="_blank" class="btn btn-lg btn-primary">Abrir mapa <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
