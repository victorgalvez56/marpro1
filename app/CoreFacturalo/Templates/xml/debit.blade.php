@php
    ...
    $series = ($note->affected_document) ? $note->affected_document->series : ($note->data_affected_document)?$note->data_affected_document->series : null;
    $document_type_id = ($note->affected_document) ? $note->affected_document->document_type_id : ($note->data_affected_document) ? $note->data_affected_document->document_type_id : null;
    $number = ($note->affected_document) ? $note->affected_document->number : ($note->data_affected_document) ? $note->data_affected_document->number : null;
