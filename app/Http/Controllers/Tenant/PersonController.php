...
use App\CoreBizag\Person\Services\PersonService;
...
class PersonController extends Controller
{
    ...
    /**
     * PurchaseQuatationController constructor.
    ...
    //     // $this->middleware('quotation.request:purchaseQuotation,api', ['only' => ['store']]);
    // }
    ...
    // public function send_invitation_portal($id)
    // {
    //     try {
    //         $person = Person::findOrFail($id);

    //         if ($person) {
    //             $result = $this->personService->sendToken($person);
    //             if ($result['success']) {
    //                 return $this->sendResponseResult($result['message'], true);
    //             }

    //             return $this->sendResponseResult($result['message'], false);
    //         }
    //         return $this->sendResponseResult($result["response"]["description"], false);
    //     } catch (Exception $ex) {
