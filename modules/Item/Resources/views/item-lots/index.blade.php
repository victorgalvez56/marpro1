...
@section('content')
    ...
    <tenant-item-lots-index></tenant-item-lots-index>
    <div class="col-xl-12">
        <div class="iq-card">
           <div class="iq-card-header d-flex justify-content-between">
              <div class="iq-header-title">
                 <h4 class="card-title">Productos <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-xl">Agregar Producto</button></h4>
