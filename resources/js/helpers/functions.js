function calculateRowItem(row_old, currency_type_id_new, exchange_rate_sale) {
    ...
    let row = {
        ...
        delivery_date: row_old.delivery_date,
    };
    ...
    if (row_old.has_plastic_bag_taxes) {
     ...
     // Purchases Items
    row.purchase_order_item_id = row_old.purchase_order_item_id;
    row.purchase_dispatch_item_id = row_old.purchase_dispatch_item_id;

    // Purchases Dispatch Item
    row.purchase_item_id = row_old.purchase_item_id;

    // Purchase Order Items
    row.purchase_quote_item_id = row_old.purchase_quote_item_id;

    // Purchase Quote Items
    row.purchase_quotation_item_id = row_old.purchase_quotation_item_id;

    // Quantity
    row.quantity_temp = row_old.quantity_temp;

    // delivery date - Quote
    row.delivery_date = row_old.delivery_date;
  row.delivery_days = row_old.delivery_days;
