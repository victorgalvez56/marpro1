                ...
                <form autocomplete="off">
                    <div class="form-body">
                        ...
                        <div class="row">
                            ...
                            >
                                <label class="control-label"
                                    >Envío de comprobantes a servidor alterno de
                                    SUNAT</label
                                >
                                <div
                                    class="form-group"
                                    :class="{
                                        'has-danger':
                                            errors.sunat_alternate_server
                                    }"
                                >
                                    <el-switch
                                        v-model="form.sunat_alternate_server"
                                        active-text="Si"
                                        inactive-text="No"
                                        @change="submit"
                                    ></el-switch>
                                    <small
                                        class="form-control-feedback"
                                        v-if="errors.sunat_alternate_server"
                                        v-text="
                                            errors.sunat_alternate_server[0]
                                        "
                                    ></small>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-4">
                                <label class="control-label"
                                    >Opciones avanzadas en POS</label
                                >
                                <div
                                    class="form-group"
                                    :class="{
                            ...
                            <div class="col-md-6 mt-4">
                                ...
                                <div
                                    class="form-group"
                                    :class="{
                                        'has-danger': errors.cotizaction_finance
                                    }"
                                >
                                    <el-switch
                        ...
                        <div class="row">
                            <div class="col-md-6 mt-4">
                                <label class="control-label"
                                    >Productos de una ubicación</label
                                >
                                <div
                                    class="form-group"
                                    :class="{
