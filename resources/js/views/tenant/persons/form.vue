            ...
            <div class="form-body">
                ...
                <div class="row mt-2" v-if="type === 'suppliers'">
                    <div class="col-md-6 center-el-checkbox">
                        <div
                            class="form-group"
                            :class="{ 'has-danger': errors.is_reception }"
                        >
                            <el-checkbox v-model="form.is_reception"
                                >Bloquear la recepción de
                                comprobantes</el-checkbox
                            ><br />
                            <small
                                class="form-control-feedback"
                                v-if="errors.is_reception"
                                v-text="errors.is_reception[0]"
                            ></small>
                        </div>
                    </div>
                    <div class="col-md-6 center-el-checkbox">
                        <div
                            class="form-group"
                            :class="{ 'has-danger': errors.is_extranet }"
                        >
                            <el-checkbox v-model="form.is_extranet"
                                >Permitir acceso a la extranet</el-checkbox
                            ><br />
                            <small
                                class="form-control-feedback"
                                v-if="errors.is_extranet"
                                v-text="errors.is_extranet[0]"
                            ></small>
                        </div>
                    </div>
                </div>
